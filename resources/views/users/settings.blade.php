<html>
    ...
    <body>
        ...
        {!! Form::model($identity, ['action' => ['UsersController@updateEmail', $identity->id], 'method' => 'PUT']) !!}
...
{!! Form::close() !!}
        ...
        {!! Form::model($identity, ['action' => ['UsersController@updatePassword', $identity->id], 'method' => 'PUT']) !!}
